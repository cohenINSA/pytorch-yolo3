...
if __name__ == "__main__":
    # Training settings
    parser = argparse.ArgumentParser(description="Training Yolo3 with Pytorch.")
    parser.add_argument("datacfg", type=str, help="Data configuration file (e.g., coco.data).")
    parser.add_argument("cfgfile", type=str, help="Net configuration file (e.g., yolo.cfg).")
    parser.add_argument("weightfile", type=str, help="Weights file.")
